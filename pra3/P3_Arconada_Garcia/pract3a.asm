...
;**************************************************************************
; Descripción:															  ;
;			En este fichero, realizamos dos funciones que se pueden		  ;
;		ejecutar desde un programa C: computeControlDigit y decodeBarCode ;
;																		  ;
;			En la primera, de un código de barras introducido, se calcula ;
;		el dígito de control, siguiendo el algoritmo estándar para ello	  ;
;																		  ;
;			En la segunda, de una cadena de caracteres que representa un  ;
;		código de barras, se extrae cada valor, y se guarda en cada campo ;
;**************************************************************************
